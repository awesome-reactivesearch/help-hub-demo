...
import "./AIButton.css"; // Import the CSS file
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stop-color="#C892FF"></stop>
          <stop offset="1" stop-color="#4CBEFF"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
...
const AIButton = ({ text, onClick = () => {} }) => {
  return (
    <button className="ask-ai-button" onClick={onClick}>
